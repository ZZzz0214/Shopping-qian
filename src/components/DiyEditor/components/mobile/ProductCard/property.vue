  ...
  <ComponentContainerProperty v-model="formData.style">
    <el-form label-width="80px" :model="formData">
      ...
      <el-card header="商品样式" class="property-group" shadow="never">
        ...
        <!-- 佣金 -->
        <el-form-item label="佣金" prop="fields.commission.show">
          <div class="flex gap-8px">
            <ColorInput v-model="formData.fields.commission.color" />
            <el-checkbox v-model="formData.fields.commission.show" />
          </div>
        </el-form-item>
