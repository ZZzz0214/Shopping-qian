...
<!--        <el-tooltip content="设置 Meta">-->
<!--          <el-button @click="handleSetMeta">-->
<!--            <Icon icon="ep:setting" :size="24" />-->
<!--          </el-button>-->
<!--        </el-tooltip>-->
      </el-button-group>
    </el-header>
...
//     title: "自定义页面",
//     group: "商品",
//     permission: "admin_biji",
//     isper: true
//   };
//
//   // 这里你可以把 `meta` 数据存储到对应的地方
//   console.log("设置的 meta 数据:", meta);
//
// // 如果 selectedComponent.value 不存在，提前返回或赋默认值
//   if (!selectedComponent.value) {
//     console.warn("selectedComponent.value 未定义");
//     return;
//   }
//
//   // 使用默认值防止 property 未定义
//   selectedComponent.value.property = {
//     ...selectedComponent.value.property || {},
//     meta
//   };
// }
